...
Example data files can be found on [Zenodo record 20427121](https://doi.org/10.5281/zenodo.19091350). You can download the files and use them as input for the pipeline to test the pipeline.
